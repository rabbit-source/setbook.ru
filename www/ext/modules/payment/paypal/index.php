<?php
  ...
  tep_mail('sivkov@setbook.ru', 'sivkov@setbook.ru', 'standart ipn processing', trim($str), STORE_NAME, STORE_OWNER_EMAIL_ADDRESS);
  die();
  ...
  if ($result == 'VERIFIED') {
    ...
    if (tep_not_null(MODULE_PAYMENT_PAYPAL_STANDARD_DEBUG_EMAIL)) {
      ...
      tep_mail('', MODULE_PAYMENT_PAYPAL_STANDARD_DEBUG_EMAIL, 'PayPal IPN Invalid Process', $email_body, STORE_NAME, STORE_OWNER_EMAIL_ADDRESS);
    }
