<?php
/////////////////////////////////////////////////////
//Внимание скрипт это скрипт выгрузки только для .KZ
/////////////////////////////////////////////////////
set_time_limit(0);

define("HTTP_SERVER", "http://www.setbook.kz");
...
*/
	...
	$HTTP_GET_VARS['file'] = "/var/www/2009/prices/yandex_xml/yandex_kz.xml";
	//http://www.setbook.ru/prices/yandex_xml/yandex_kz.xml
	
	$logs->write("START [KZ, ".(isset($HTTP_GET_VARS['type'])?$HTTP_GET_VARS['type']:'ALL')."] ".$HTTP_GET_VARS['file']);
