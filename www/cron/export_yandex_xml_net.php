<?php
/////////////////////////////////////////////////////
//Внимание скрипт это скрипт выгрузки только для .NET
/////////////////////////////////////////////////////
set_time_limit(0);

define("HTTP_SERVER", "http://www.setbook.net");
...
*/
	...
	$HTTP_GET_VARS['file'] = "/var/www/2009/prices/yandex_xml/yandex_net.xml";
	//http://www.setbook.ru/prices/yandex_xml/yandex_net.xml
	
	$logs->write("START [NET, ".(isset($HTTP_GET_VARS['type'])?$HTTP_GET_VARS['type']:'ALL')."] ".$HTTP_GET_VARS['file']);
