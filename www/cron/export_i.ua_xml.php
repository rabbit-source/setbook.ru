<?php
/////////////////////////////////////////////////////
//Внимание скрипт это скрипт выгрузки только для i.ua
/////////////////////////////////////////////////////
set_time_limit(0);
...
include('cron/include/i.ua.functions.php');
...
*/
	...
	$HTTP_GET_VARS['file'] = "/var/www/2009/prices/yandex_xml/i.ua.xml";
	//http://www.setbook.ru/prices/yandex_xml/i.ua.xml
	
	$logs->write("START [I.UA, ".(isset($HTTP_GET_VARS['type'])?$HTTP_GET_VARS['type']:'ALL')."] ".$HTTP_GET_VARS['file']);
