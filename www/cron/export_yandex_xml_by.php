<?php
/////////////////////////////////////////////////////
//Внимание скрипт это скрипт выгрузки только для .BY
/////////////////////////////////////////////////////
set_time_limit(0);

define("HTTP_SERVER", "http://www.setbook.by");
...
*/
	...
	$HTTP_GET_VARS['file'] = "/var/www/2009/prices/yandex_xml/yandex_by.xml";
	//http://www.setbook.ru/prices/yandex_xml/yandex_by.xml
	
	$logs->write("START [BY, ".(isset($HTTP_GET_VARS['type'])?$HTTP_GET_VARS['type']:'ALL')."] ".$HTTP_GET_VARS['file']);
