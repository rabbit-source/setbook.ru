...
// if there is nothing in the customers cart, redirect them to the shopping cart page
  ...
  $content = FILENAME_CHECKOUT_PAYMENT_ADDRESS;
  $javascript = 'checkout_payment_address.js.php';
...
// process the selected billing destination
      ...
      $check_address_query = tep_db_query("select count(*) as total from " . TABLE_ADDRESS_BOOK . " where customers_id = '" . (int)$customer_id . "' and address_book_id = '" . $billto . "'");
...
// if no billing destination address was selected, use their own address as default
  ...
  $breadcrumb->add($page['pages_name'], tep_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL'));
