<?php
  ...
  function tep_db_error($query, $errno, $error) {
	global $_SERVER;
	if (in_array(basename($_SERVER['PHP_SELF']), array('products_upload.php', 'discounts.php'))) tep_mail('sivkov@setbook.ru', 'sivkov@setbook.ru', 'ошибка', '<strong>' . $errno . ' - ' . $error . '<br /><br />' . $query . '</strong>', STORE_NAME, STORE_OWNER_EMAIL_ADDRESS);
  ...
  function tep_db_list_dbs($link = 'db_link') {
    global $$link;
