...
$s_url = preg_replace('/\/$/', '', DIR_WS_CATALOG);
$s_dir = DIR_FS_CATALOG;

$s_url = preg_replace('/\/$/', '', $s_url);
$s_dir = preg_replace('/\/$/', '', $s_dir);

// echo session_id();
// print_r($_SESSION);

define('SITE_WS_CATALOG', $s_url);
define('SITE_FS_CATALOG', $s_dir);
...
$fckphp_config['basedir']=SITE_FS_CATALOG;
...
$fckphp_config['urlprefix']=SITE_WS_CATALOG;
/*==============================================================================*/
...
/*------------------------------------------------------------------------------*/
$fckphp_config['UserFilesPath'] = "/images/" ;
// $fckphp_config['UserFilesPath'] = DIR_FS_CATALOG_IMAGES ;
/*==============================================================================*/
...
$fckphp_config['ResourceAreas']['File'] =array(
	...
	'AllowedExtensions'	=>	array("zip","doc","xls","pdf","rtf","csv","jpg","gif","jpeg","png","avi","mpg","mpeg","swf","fla","txt"),
...
$fckphp_config['ResourceAreas']['Media'] =array(
	'AllowedExtensions'	=>	array("swf","fla","jpg","gif","jpeg","png","avi","mpg","mpeg","mp3"),
	'AllowedMIME'		=>	array(),
	'MaxSize'		=>	5120,
	'DiskQuota'		=>	-1,
	'HideFolders'		=>	array("^\."),
