...
define('TEXT_INFO_CURRENCY_ALLOW_AUTO_UPDATE', 'Разрешить обновлять автоматически?');
...
define('TEXT_INFO_CURRENCY_NOT_CHANGED', 'Изменение курса %s (%s) - менее %s%%. Обновления не требуется.');
define('TEXT_INFO_CURRENCY_NOT_CHANGED_1', 'Курс валюты %s (%s) не изменился. Обновления не требуется.');
?>