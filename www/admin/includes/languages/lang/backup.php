...
define('TEXT_INFO_RESTORE', 'Не прерывайте процесс восстановления.<br><br>Большая база данных, более долгий процесс!<br><br>Если возможно, используйте shell команды.<br><br>Например:<br><br><b>mysql -h"' . DB_SERVER . '" -u"' . DB_SERVER_USERNAME . '" -p"пароль" ' . DB_DATABASE . ' &lt; %s</b> %s');
...
define('TEXT_INFO_USE_BZIP2', 'Использовать BZIP2');
...
define('ERROR_FILE_NOT_REMOVEABLE', 'Ошибка: Невозможно удалить файл, нет доступа. Установите верные права доступа.');
