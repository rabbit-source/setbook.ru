...
// Include application configuration parameters
  ...
  {
// Include application configuration parameters
  	define('DIR_FS_CATALOG', 'C:/Projects/SetBook/Projects/setbook_ru/');
  	require(DIR_FS_CATALOG . 'includes/configure_debug.php');
  	$REMOTE_USER = 'setbook';
  }
...
// check if a default language is set
  ...
  if (HTTP_SERVER=='http://www.setbook.com.ua') {
  	$epaymentMethodFilename = 'interkassa.php';
  	$epaymentMethodName = 'Интеркасса';
  }
  else {
  	$epaymentMethodFilename = 'roboxchange.php';
  	$epaymentMethodName = 'Робокасса';
  }
							...
							array('title' => BOX_HEADING_ORDERS,
								  ...
								  'pages' => array(FILENAME_CUSTOMERS => BOX_ORDERS_CUSTOMERS,
												   ...
												   FILENAME_ADVANCE_ORDERS => BOX_ORDERS_ADVANCE_ORDERS,
								  					$epaymentMethodFilename => $epaymentMethodName),
