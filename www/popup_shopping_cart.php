<?php
  ...
  $content = FILENAME_POPUP_SHOPPING_CART;
  ...
  $translation_query = tep_db_query("select pages_translation_key, pages_translation_value from " . TABLE_PAGES_TRANSLATION . " where pages_filename = '" . tep_db_input(basename(FILENAME_SHOPPING_CART)) . "' and language_id = '" . (int)$languages_id . "'");
  ...
  $breadcrumb->add($page['pages_name'], tep_href_link(FILENAME_SHOPPING_CART));
