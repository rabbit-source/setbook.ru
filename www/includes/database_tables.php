...
// define the database table names used in the project
  ...
  define('TABLE_PRICELISTS', 'pricelists');
  ...
  define('TABLE_PRODUCTS_SEARCH', 'products_search');
  define('TABLE_PRODUCTS_TO_SEARCH', 'products_to_search');
  ...
  define('TABLE_WISHLISTS', 'wishlists');
